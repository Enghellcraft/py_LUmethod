...
def my_lu_decomposition(A):
    ...
    print_matrix_truncated(A)
    print(f"La matriz L es:")
    print_matrix_truncated(L)
    print(f"La matriz U es:")
    print_matrix_truncated(U)
    print_heat_map(L, U)
        ...
        return print("Algun Elemento en la diagonal es 0 y no puede resolverse por LU")
         ...
         if my_square_matrix(A) == False:
            ...
            if my_determinant(A) == False:
                ...
                # Resuelve por LU, obteniendo el vector solución         
                x = linalg.lu_solve(LU, B) 
                
                my_lu_decomposition(A)
                print(f"Para b = {B}")
                # Trunca los valores a un decimal
...
def print_matrix_truncated(A):
    a = np.array(A)
    for row in a: 
        # Si el valor es int lo imprime como tal, si es un float lo trunca a un decimal
        row_str = [f"{value:.1f}" if not value.is_integer() else f"{value:.0f}" for value in row]
        # Conversión del espacio para que sea parejo entre los valores
        row_str = [value.rjust(5) for value in row_str]
        # Los une para su implesión
        print(' '.join(row_str))

## Print matrix graphics
def print_heat_map(L, U):
    # Armado de dos columnas para ver en paralelo L y U
    fig, axs = plt.subplots(ncols=2)
    # Utiliza el mapa de calor desde el rojo como positivos hasta el azul como negativos
    cmap = sns.diverging_palette(220, 10, as_cmap=True)
    plt.title('Matrices L y U mediante Método LU')
    # Toma al cero como blanco y lo centra
    sns.heatmap(L, ax=axs[0], annot=True, cmap=cmap, center=0,)
    axs[0].set_title("La matriz Triangular Inferior (L)")
    sns.heatmap(U, ax=axs[1], annot=True, cmap=cmap, center=0,)
    axs[1].set_title("La matriz Triangular Superior (U)")
    plt.show()     
...
b_for_3by3_matrix = ([1,2,3])

b_for_2by2_matrix = ([1,2])
...
my_lu(zero_determinant_submatrix, b_for_3by3_matrix)
print("                                                                                  ")
print("    • Se emiten las matrices L y U de una matriz que cumple los requisitos:       ") 
my_lu(doable_matrix, b_for_3by3_matrix)
...
print("    • Se comprueba para cada fila:      2 * i - 2                                 ")
print("    y1 = 2. 1 - 2 = 0                                                             ")
print("    y2 = 2. 2 - 2 = 2                                                             ")
print("    y3 =  2. 3 - 2 = 4                                                            ")
print("                                                                                  ")
...
print("    x3 * 2.5 = y3                        ---> 1 Operación                         ")
print("    • Se comprueba para cada fila:                                                ")
print("    x1 =  2. (3 + 1 - 1) - 1 = 5  como hay otro 1 en la matriz se descuenta -> 4  ")
print("    x2 =  2. (3 + 1 - 2) - 1 = 3                                                  ")
print("    x3 =  2. (3 + 1 - 3) - 1 = 1                                                  ")
print("                                                                                  ")
...
print("                                                                                  ")
print("    • Se emiten las matrices L y U de una matriz que cumple los requisitos:       ") 
my_lu(doable_matrix_2, b_for_3by3_matrix)
...
print("    x3 * -0.5 = y3                       ---> 1 Operación                         ")
print("    • Se comprueba para cada fila:      2 * ( n + i - 1) - 1                      ")
print("    x1 =  2. (3 + 1 - 1) - 1 = 5                                                  ")
print("    x2 =  2. (3 + 1 - 2) - 1 = 3                                                  ")
print("    x3 =  2. (3 + 1 - 3) - 1 = 1                                                  ")
print("                                                                                  ")
...
print("                                                                                  ")
print("    • Se emiten las matrices L y U de una matriz que cumple los requisitos:       ") 
my_lu(doable_matrix_3, b_for_2by2_matrix)
...
print("    • Se comprueba para cada fila:  2 * ( n + i - 1) - n                          ")
print("    x1 =  2. (2 + 1 - 1) - 1 = 3                                                  ")
print("    x2 =  2. (2 + 1 - 2) - 1 = 1  como hay otro 1 en la matriz se descuenta -> 0  ")
print("                                                                                  ")
print("    Como A es una matriz inversible, entonces podría haber otra descomposicion LU ")
